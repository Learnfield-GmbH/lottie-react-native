...
Pod::Spec.new do |s|
  ...
  s.pod_target_xcconfig = { 'OTHER_LDFLAGS' => '$(inherited) -framework Lottie',
                            'FRAMEWORK_SEARCH_PATHS[sdk=iphoneos*]'        => '$(inherited) ../../ios/Submodules/Home/Home/iOS/Submodules/wyntonDependenciesPrecompiled/Frameworks/Lottie.xcframework/ios-arm64',
                            'FRAMEWORK_SEARCH_PATHS[sdk=iphonesimulator*]' => '$(inherited) ../../ios/Submodules/Home/Home/iOS/Submodules/wyntonDependenciesPrecompiled/Frameworks/Lottie.xcframework/ios-arm64_x86_64-simulator'
                           }
